...
# Neutral throttle value (adjust as needed)
...
try:
    ...
    print("Connection lost or interrupted, setting throttle to neutral.")
    set_speed(ESC_LEFT_GPIO_PIN, NEUTRAL_THROTTLE)
    set_speed(ESC_RIGHT_GPIO_PIN, NEUTRAL_THROTTLE)
